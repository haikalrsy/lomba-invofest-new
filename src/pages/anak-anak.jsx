...
import Carousel from '../components/carouselanak';
...
function AnimatedGrowthChart() {
  ...
  const [chartData, setChartData] = useState({
    labels: ['7 Tahun', '7.5 Tahun', '8 Tahun', '8.5 Tahun', '9 Tahun', '9.5 Tahun', '10 Tahun'],
    datasets: [
      {
  ...
  // Data tinggi badan ideal (rata-rata WHO/IDAI untuk anak perempuan & laki-laki usia 7–10 tahun)
  // Diambil dari standar pertumbuhan anak sehat
  const finalData = [122, 125, 128, 131, 133, 136, 138]; // dalam cm
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      // Efek easing smooth (easeOutCubic)
  ...
  const options = {
    ...
    animation: {
      duration: 0, // karena animasi kita handle manual via useEffect
    },
  };
...
const accordionData = [
  {
    ...
    content: 'Gizi seimbang sangat penting untuk mendukung pertumbuhan dan perkembangan otak anak agar lebih optimal.',
  },
  {
    title: 'Stimulasi Dini untuk Perkembangan Anak',
    content: 'Berikan stimulasi yang sesuai usia seperti bermain, bercerita, dan bernyanyi untuk menunjang tumbuh kembang anak.',
  },
  {
    title: 'Cegah Stunting dengan Pola Makan yang Tepat',
    content: 'Pastikan anak mendapatkan asupan makanan bergizi sejak dini serta perhatikan pola makan yang teratur.',
  },
  {
    title: 'Mengenal Tumbuh Kembang Anak Usia Dini',
    content: 'Kenali tahapan perkembangan anak agar bisa memberikan dukungan yang tepat sesuai usia dan kemampuannya.',
  },
  {
    title: 'Membentuk Kebiasaan Sehat Sejak Kecil',
    content: 'Ajarkan kebiasaan sehat seperti mencuci tangan, makan teratur, dan tidur cukup sejak usia dini.',
  }
];
  const redAccordionData = [
  {
    title: 'Transisi Makanan: Dari MPASI ke Makanan Keluarga',
    content: 'Perkenalkan tekstur dan rasa makanan yang lebih beragam secara bertahap untuk mendukung perkembangan motorik oral dan mencegah penolakan makanan.',
  },
  {
    title: 'Menu Seimbang untuk Anak Aktif',
    content: 'Pastikan menu harian anak mengandung karbohidrat kompleks, protein hewani/nabati, lemak sehat, serta sayur dan buah untuk mendukung tumbuh kembang optimal.',
  },
  {
    title: 'Porsi Makan yang Tepat untuk Anak',
    content: 'Sesuaikan porsi makanan dengan usia, tingkat aktivitas, dan kebutuhan gizi anak agar mencegah kekurangan atau kelebihan berat badan.',
  },
  {
    title: 'Membentuk Kebiasaan Makan Sehat',
    content: 'Ajarkan anak untuk makan dengan teratur, menghindari camilan tinggi gula/garam, serta menciptakan suasana makan yang menyenangkan tanpa paksaan.',
  },
];
        ...
        <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          >
            <div className="space-y-3 sm:space-y-4">
              ...
              >
                Gizi Anak <span className="text-sky-900">Tercukupi</span>
              </motion.h1>
              <motion.p 
                ...
                data-aos="fade-up"
              >
                Pastikan anak mendapat nutrisi optimal dengan rencana ASI yang tepat. 
                Temukan tips untuk menjadikan pskys menyusui lebih lancar dan nyaman.
              </motion.p>
            </div>
